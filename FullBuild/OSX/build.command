...
libtool -static -o libpicoengineio.a "$Box2D" "$CocosDenshion" "$FlMML" "$Lua" "$PicoGame" "$freetype"
libtool -static -o libpicoengine.a "$Box2D" "$CocosDenshion" "$FlMML" "$LuaNoIO" "$PicoGame" "$freetype"
libtool -static -o libpicoenginejit.a "$Box2D" "$CocosDenshion" "$FlMML" "$LuaJIT" "$PicoGameJIT" "$freetype"
