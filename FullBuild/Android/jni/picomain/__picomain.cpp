...
void Java_org_cocos2dx_lib_Cocos2dxRenderer_nativeInit(JNIEnv*  env, jobject thiz, jint w, jint h)
{
    ...
    else
    {
		...
		cocos2d::CCScene* baseScene = cocos2d::CCDirector::sharedDirector()->getRunningScene();
		PPGameScene* scene = (PPGameScene*)baseScene->getChildByTag(9999);
		if (scene) {
			scene->g->textureManager->reloadAllTexture();
		}
//		cocos2d::CCEGLView *view = &cocos2d::CCEGLView::sharedOpenGLView();
//		getChildByTag
